...
function slideVotes(pollId,currentPercent)
{
	...
	for(var prop in pollVotes[pollId]){
		if(pollVotes[pollId][prop]>=currentPercent){
			...
			obj.style.width = Math.max(graphMinWidth,Math.round(currentPercent/100*graphMaxWidth)+5) + 'px';
		}			
	}
...
{	
	...
	if(optionId){
		...
		ajaxObjects[ajaxIndex].requestFile = 'pollId=' + pollId + '&optionId=' + optionId;
		ajaxObjects[ajaxIndex].serverSideFile = serverSideFile;
